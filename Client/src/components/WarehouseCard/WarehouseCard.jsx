...
const WarehouseCard = ({ warehouseObject, totalEdits, setTotalEdits }) => {
  if (typeof warehouseObject !== "object") {
      ...
      <div className="warehouse-card warehouse__header-row">
        <div className="warehouse-card__details">
          <div className="warehouse-card__left">
            <h4 className="warehouse-card__heading--table warehouse-card__text-container">
              Warehouse
            </h4>
            <h4 className="warehouse-card__heading--table warehouse-card__text-container warehouse-card__address">
              Address
            </h4>
          </div>
          <div className="warehouse-card__right">
            <h4 className="warehouse-card__heading--table warehouse-card__text-container warehouse-card__contact-name">
              Contact Name
            </h4>
            <h4 className="warehouse-card__heading--table warehouse-card__text-container warehouse-card__contact-info">
              Contact Information
            </h4>
          </div>
        </div>
        <div className="warehouse-card__icons">
          <h4 className="warehouse-card__heading--no-scroll">Actions</h4>
        </div>
      </div>
    );
  }
  ...
  return (
    <li className="warehouse-card">
      ...
      <div className="warehouse-card__details">
        <div className="warehouse-card__left">
          <h4 className="warehouse-card__heading">Warehouse</h4>
          <Cardlink
            id={id}
        ...
        <div className="warehouse-card__right">
          ...
          <div className="warehouse-card__text-container warehouse-card__contact-name">
            <p className="table-text">{contact_name}</p>
          </div>
          <h4 className="warehouse-card__heading warehouse-card__contact-name">
            Contact Information
          </h4>
          <div className="warehouse-card__text-container warehouse-card__contact-info">
            <p className="table-text">{contact_phone}</p>
            <p className="table-text">{contact_email}</p>
          </div>
        </div>
      </div>
      <ActionIcons
